...
namespace PizzaPort.Infrastructure.Entities;

public partial class PizzaPortDBContext : DbContext
{
    public PizzaPortDBContext(DbContextOptions<PizzaPortDBContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UserToke__3214EC07E25C0308");
